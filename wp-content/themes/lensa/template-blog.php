...
query_posts('paged='.get_query_var('paged').'&cat=1');
	 ...
	 ?>
        <article class="entry-post">
          ...
          <figure class="entry-media">
			<?php  
					...
					if (($single_top[0]!='')||($single_top[0]=='none')){
						...
						colabs_image('width=300&align=center&link=img');		
					}
			?>
          </figure><!-- .entry-media -->
          ...
          <div class="entry-content">
			...
			<p class="more"><a href="<?php the_permalink() ?>"><?php _e("Читать далее","colabsthemes"); ?></a></p>
		  </div><!-- .entry-content -->
