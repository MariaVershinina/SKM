...
query_posts('paged='.get_query_var('paged').'&cat=4');
	 ...
	 ?>
        <article class="line">
          ...
          <div class="entry-content">
			...
			<p class="more"><a href="<?php the_permalink() ?>"><?php _e("Далее","colabsthemes"); ?></a></p>
		  </div><!-- .entry-content -->
	 ...
	 <?php include (TEMPLATEPATH . '/sidebar_video.php'); ?>
